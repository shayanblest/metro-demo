...
import {SimpleDateTime} from './simple-datetime.model';
...
@Component({
    selector: 'metro-datetime-picker',
  imports: [CommonModule, PersianDigitsPipe, ToTimeStampPipe],
...
export class DatetimePickerComponent
  ...
  constructor(
    ...
    public metroTranslate: MetroTranslateService
  ) {
